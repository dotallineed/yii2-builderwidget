...
class BuilderWidget extends Component
{
	...
	const EVENT_WIDGET_CHANGE = 'widgetChange';
	...
	public function create($item, $quantity = 1)
	{
		...
		$this->trigger(self::EVENT_ITEM_PUT, new BuilderWidgetActionEvent([
			'action' => BuilderWidgetActionEvent::ACTION_ITEM_PUT,
			'item' => $this->items[$item->getId()],
		]));
		$this->trigger(self::EVENT_WIDGET_CHANGE, new BuilderWidgetActionEvent([
			'action' => BuilderWidgetActionEvent::ACTION_ITEM_PUT,
			'item' => $this->items[$item->getId()],
		]));
		$this->save();
	...
	public function update($item, $quantity)
	{
		...
		$this->trigger(self::EVENT_ITEM_UPDATE, new BuilderWidgetActionEvent([
			'action' => BuilderWidgetActionEvent::ACTION_UPDATE,
			'item' => $this->items[$item->getId()],
		]));
		$this->trigger(self::EVENT_WIDGET_CHANGE, new BuilderWidgetActionEvent([
			'action' => BuilderWidgetActionEvent::ACTION_UPDATE,
	...
	{
		$this->trigger(self::EVENT_BEFORE_ITEM_REMOVE, new BuilderWidgetActionEvent([
			'action' => BuilderWidgetActionEvent::ACTION_BEFORE_REMOVE,
			'item' => $this->items[$id],
		]));
		$this->trigger(self::EVENT_WIDGET_CHANGE, new BuilderWidgetActionEvent([
			'action' => BuilderWidgetActionEvent::ACTION_BEFORE_REMOVE,
	...
	public function deleteAll()
	{
		$this->items = [];
		$this->trigger(self::EVENT_WIDGET_CHANGE, new BuilderWidgetActionEvent([
			'action' => BuilderWidgetActionEvent::ACTION_REMOVE_ALL,
		]));
		$this->save();
	}
	...
	public function setItems($items)
	{
		...
		$this->trigger(self::EVENT_WIDGET_CHANGE, new BuilderWidgetActionEvent([
			'action' => BuilderWidgetActionEvent::ACTION_SET_ITEMS,
		]));
		$this->save();
	}
